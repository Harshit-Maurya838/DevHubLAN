        ...
        <header className="h-14 border-b border-dark-800 bg-dark-900 flex items-center justify-between px-6 shadow-sm z-10 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className={`p-2 rounded-md transition-colors ${isSecurityOpen ? 'bg-indigo-600 text-white' : 'text-gray-400 hover:bg-dark-700 hover:text-white'}`}
              title="Security & Trust Dashboard"
            >
              <Shield size={20} />
            </button>
            <button 
